...
namespace Easy_Backup\Models;

use App\Models\Crud_model;

class Easy_Backup_settings_model extends Crud_model {

    protected $table = null;

    function __construct() {
        $this->table = 'easy_backup_settings';
    ...
    function get_all_settings() {
        $settings_table = $this->db->prefixTable('easy_backup_settings');
