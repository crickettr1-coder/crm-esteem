...
$meta_plugin_routes = ROOTPATH . 'plugins/Esteem_Meta_Lead_Capture/Config/Routes.php';
$meta_active_plugins = APPPATH . 'Config/activated_plugins.json';
if (is_file($meta_plugin_routes) && is_file($meta_active_plugins) && in_array('Esteem_Meta_Lead_Capture', (array) @json_decode(file_get_contents($meta_active_plugins)))) {
    require $meta_plugin_routes;
}
